...
#region Configure VirtualMachine
    ...
    & $VirtualBoxManage modifyvm $OSXVMName --memory 4096 --vram 128 --cpus 2 --usb on --usb on --pae on --hwvirtex on --nestedpaging on --vtxvpid on --vtxvpid on --chipset ich9 --vram 128 --cpus $NumberofCPUs --usb on --pae on --hwvirtex on --nestedpaging on --vtxvpid on --chipset ich9 --rtcuseutc on --firmware efi --boot1 disk --boot2 disk --boot3 none --boot4 none --mouse usbtablet --keyboard usb --usbehci on --hpet on
